...
-- Dump dei dati della tabella esfx.instagram_accounts: ~1 rows (circa)
...
-- Dump dei dati della tabella esfx.instagram_likes: ~0 rows (circa)
DELETE FROM `instagram_likes`;
/*!40000 ALTER TABLE `instagram_likes` DISABLE KEYS */;
/*!40000 ALTER TABLE `instagram_likes` ENABLE KEYS */;
...
-- Dump dei dati della tabella esfx.instagram_posts: ~0 rows (circa)
