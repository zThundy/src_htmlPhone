<template>
   <div style="width: 326px; height: 743px;"  class="phone_app">
    ...
    <div class="actionbox">
      ...
      <div class="action raccrocher" :class="{disableTrue: status === 0 && select !== 0}" @click.stop="raccrocher">
      ...
      <div class="action deccrocher" v-if="status === 0" :class="{disableFalse: status === 0 && select !== 1}" @click.stop="deccrocher">
