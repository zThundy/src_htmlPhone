...
if (process.env.NODE_ENV !== 'production') {
  ...
  state.messages = [
    ...
    {id: 5, transmitter: numRandom, time, message: '%CONTACT%:55529322::questoenuovo::questoenuovo@phone.com:', isRead: 1, owner: 0},
    {id: 6, transmitter: numRandom, time, message: '%CONTACT%:55529322::questoenuovo::questoenuovo@phone.com:', isRead: 1, owner: 0},
