...
if (process.env.NODE_ENV !== 'production') {
  ...
  state.messages = [
    ...
    {id: 21, transmitter: numRandom, time, message: ':boy: :boy:', isRead: 1, owner: 0},
    ...
    {id: 11, transmitter: '55589231', time, message: 'Cazz c fai ca? !', isRead: 1, owner: 1},
    {id: 12, transmitter: '55589231', time, message: 'Cazz c fai ca? !', isRead: 1, owner: 1},
    {id: 13, transmitter: '55589231', time, message: 'Cazz c fai ca? !', isRead: 1, owner: 1}
  ]
}
